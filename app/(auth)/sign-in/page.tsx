  ...
  return (
    <div className="grid min-h-screen w-full grid-cols-1 md:grid-cols-2">
      ...
      <div className="relative hidden flex-col bg-muted p-10 text-white md:flex dark:border-r">
        ...
        <Link href="/" className="relative z-20 flex items-center gap-2 text-lg font-bold w-fit">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;Our missed call rate dropped to zero overnight. The AI sounds
              so natural that most clients don't even realize they're talking to
              software.&rdquo;
            </p>
            <footer className="text-sm font-medium opacity-80">
              Sarah Jenkins, Radiant Salon
            </footer>
          </blockquote>
        </div>
      </div>
